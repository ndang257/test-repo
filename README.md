# Analyzing Warehouse Data from Obeta - Project by LRIN
In the following repository, you will find the ETL process using different tools to achieve the assigned project on the datasets provided by Obeta. Main tools are `Python`, `MySQL DB` and `Tableau`.
